...
public final class FragmentHomeCoursesBinding implements ViewBinding {
  ...
  private FragmentHomeCoursesBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView rvPopularCourses, @NonNull TextView tvPercentage) {
  ...
  public static FragmentHomeCoursesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeCoursesBinding((FrameLayout) rootView, rvPopularCourses, tvPercentage);
    }
