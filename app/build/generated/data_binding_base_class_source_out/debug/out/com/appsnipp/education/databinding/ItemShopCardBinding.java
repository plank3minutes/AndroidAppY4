...
public final class ItemShopCardBinding implements ViewBinding {
  ...
  private ItemShopCardBinding(@NonNull CardView rootView, @NonNull CardView cardViewCourse,
  ...
  public static ItemShopCardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      CardView cardViewCourse = (CardView) rootView;
      ...
      return new ItemShopCardBinding((CardView) rootView, cardViewCourse, image, tvCantidadCursos,
          tvTitulo);
    }
