...
public class FontSizeUtils {
    ...
    private static final float[] HEADER_SIZES = {24, 28, 32};       // Large headers (e.g. Profile title)
    private static final float[] TITLE_SIZES = {18, 20, 24};        // Section titles
    private static final float[] SUBTITLE_SIZES = {14, 16, 18};     // Section subtitles
